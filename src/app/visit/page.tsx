    ...
    <main className="min-h-screen bg-[#FAF6EE] text-[#0F0F08]">
      <section className="relative overflow-hidden px-5 py-10 sm:px-8 lg:px-12">
        ...
        <div className="mx-auto max-w-[1200px]">
          <a href="/" className="inline-flex items-center gap-3 text-sm text-black/50 transition hover:text-[#8B6116]">← Back to Church of the Harvest</a>
          <div className="grid min-h-[78vh] items-center gap-14 py-16 lg:grid-cols-[1.05fr_.95fr]">
            ...
            <div className="grid gap-4">
              <div className="rounded-[2rem] bg-[#C8922A] p-8">
                <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-black/55">Sunday Gathering</p>
                <p className="display-title mt-3 text-6xl font-semibold tracking-[-0.05em]">10:00 AM</p>
              </div>
              <div className="rounded-[2rem] border border-black/10 bg-white/70 p-8">
                <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-[#8B6116]">Location</p>
                <p className="display-title mt-3 text-3xl font-semibold">342 Hoy Rd</p>
                <p className="mt-1 text-black/50">Laurel, MS 39443</p>
              </div>
              <div className="rounded-[2rem] border border-black/10 bg-white/70 p-8">
                <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-[#8B6116]">Questions before Sunday?</p>
                <a href="mailto:churchoftheharvest601@gmail.com" className="mt-3 block font-semibold">churchoftheharvest601@gmail.com</a>
              </div>
            </div>
          </div>
        </div>
